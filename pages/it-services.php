                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card tech-card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <h4 class="text-green">IT Consulting</h4>
                            <p>Strategic guidance to align technology with your business objectives.</p>
                            <ul class="text-start">
                                <li><i class="fas fa-check-circle text-green me-2"></i> Technology roadmaps</li>
                                <li><i class="fas fa-check-circle text-green me-2"></i> Digital transformation</li>
                                <li><i class="fas fa-check-circle text-green me-2"></i> IT infrastructure planning</li>
                                <li><i class="fas fa-check-circle text-green me-2"></i> Cost optimization</li>
                            </ul>
                        </div>
                    </div>
                </div>
