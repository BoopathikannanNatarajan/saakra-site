                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card ecom-card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="https://www.amazon.in" target="_blank" class="btn btn-outline-green mt-3">Visit Amazon</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card ecom-card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="https://www.flipkart.com" target="_blank" class="btn btn-outline-green mt-3">Visit Flipkart</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card ecom-card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <a href="https://www.meesho.com" target="_blank" class="btn btn-outline-green mt-3">Visit Meesho</a>
                        </div>
                    </div>
                </div>
