        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active d-flex align-items-center fade-in delay-3" href="about.php">
        ...
        <div class="row g-3 justify-content-center">
            <div class="col-md-4 mb-4">
                <div class="card team-card h-100">
                    <div class="text-center pt-3">  <!-- Added wrapper div for better control -->
                        <img src="images/MDsaakra.jpg" class="card-img-top rounded-circle" style="width: 150px; height: 150px; object-fit: cover;" alt="CEO">
                    </div>
                    <div class="card-body text-center">
                        <h5 class="text-green">SUHANA V</h5>
                        <p class="text-muted">DIRECTOR (SAAKRA ENTERPRISES PVT LTD)</p>
                        <p class="small">Experience in software development and quality assurance, Director of Saakra Enterprises with a vision to deliver testing solutions and innovative software products that transform businesses.</p>
            ...
            <div class="col-md-4 mb-4">
                <div class="card team-card h-100">
                    <div class="text-center pt-3">  <!-- Added wrapper div for better control -->
                        <img src="images/Directorsaakra.jpg" class="card-img-top rounded-circle" style="width: 150px; height: 150px; object-fit: cover;" alt="Director">
                    </div>
                    <div class="card-body text-center">
                        <h5 class="text-green">AASHIK AASAN K</h5>
                        <p class="text-muted">MD (SAAKRA ENTERPRISES PVT LTD)</p>
                        <p class="small">With 16+ years of cross-domain expertise spanning IT solutions, trading operations ,Transport Services, franchise development, Indian oil vendor, and e-commerce ventures, Managing Director of Saakra Enterprises with a vision for diversified business excellence.</p>
                        <div class="social-links">
                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fas fa-envelope"></i></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="pages/oil-vendor.php" class="text-white">Oil Vendor</a></li>
                    <li class="mb-2"><a href="pages/tyres-trading.php" class="text-white">Tyres Trading</a></li>
                    <li class="mb-2"><a href="pages/atm-franchise.php" class="text-white">ATM Franchise</a></li>
                    <li class="mb-2"><a href="services/transport.php" class="text-white">Transport</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-6 mb-4">
                <h5 class="text-green">Digital Services</h5>
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="pages/ecommerce.php" class="text-white">E-Commerce</a></li>
                    <li class="mb-2"><a href="pages/it-services.php" class="text-white">IT Services</a></li>
                    <li class="mb-2"><a href="pages/it-services.php" class="text-white">Web Development</a></li>
                    <li class="mb-2"><a href="pages/it-services.php" class="text-white">Digital Marketing</a></li>
                </ul>
            </div>
            <div class="col-lg-4 mb-4">
                <h5 class="text-green">Contact Us</h5>
                <ul class="list-unstyled">
                    <li class="mb-3"><i class="fas fa-map-marker-alt me-2 text-green"></i> Salem, Tamilnadu, India</li>
                    <li class="mb-3"><i class="fas fa-phone me-2 text-green"></i> +91 99441 11597</li>
                    <li class="mb-3"><i class="fas fa-envelope me-2 text-green"></i> saakraenterprisespvtltd.com</li>
                </ul>
            </div>
        </div>
