...
<head>
    ...
    <style>
        ...
        .navbar.scrolled {
            ...
            background-color: rgba(18, 187, 57, 0.95) !important;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark-green sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="./images/logo.png" alt="Saakra Enterprises" height="55" class="me-2 border border-2 border-white rounded-circle p-1 bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active d-flex align-items-center fade-in delay-4" href="contact.php">
    ...
    <section class="py-5 bg-white" id="contact-form">
  <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="pages/oil-vendor.php" class="text-white">Oil Vendor</a></li>
                        <li><a href="pages/tyres-trading.php" class="text-white">Tyres Trading</a></li>
                        <li><a href="pages/atm-franchise.php" class="text-white">ATM Franchise</a></li>
                        <li><a href="pages/transport.php" class="text-white">Transport</a></li>
                    </ul>
                </div>
                <div class="col-lg-2 col-md-6 mb-4">
                    <h5 class="text-green">Digital Services</h5>
                    <ul class="list-unstyled">
                        <li><a href="pages/ecommerce.php" class="text-white">E-Commerce</a></li>
                        <li><a href="pages/it-services.php" class="text-white">IT Services</a></li>
                        <li><a href="pages/it-services.php" class="text-white">Web Development</a></li>
                        <li><a href="pages/it-services.php" class="text-white">Digital Marketing</a></li>
                    </ul>
                </div>
                <div class="col-lg-4 mb-4">
