        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-end">
                    <img src="../images/tyes-hero.jpg" alt="Tyres Trading Services" class="img-fluid hover-scale" style="max-width: 300px; height: auto; transform: perspective(1000px) rotateY(0deg); transition: transform 0.5s;">
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body p-4">
                            ...
                            <p>"I've been buying tyres for my car from Saakra for 3 years now. They always have the best brands in stock and their staff is very knowledgeable about tyre specifications."</p>
                        </div>
                    </div>
                </div>
