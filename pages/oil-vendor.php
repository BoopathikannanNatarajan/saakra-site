    ...
    <header class="page-header py-5 service-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="text-green">Indian Oil Vendor for Professional Landscaping & Construction</h1>
                ...
                <div class="col-lg-6 text-lg-end text-center mt-lg-0 mt-4">
                    <img src="../images/indianoil_logo.jpg" alt="Landscaping Services" class="img-fluid hover-scale" style="max-width: 400px; height: auto; transform: perspective(1000px) rotateY(0deg); transition: transform 0.5s;">
                </div>
                <script>
                    ...
                    <div class="card testimonial-card h-100 border-green">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0 text-green">Rajesh Kumar</h6>
                    ...
                    <div class="card testimonial-card h-100 border-green">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-0 text-green">Priya Anand</h6>
    ...
    <footer class="py-5 bg-dark text-white">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    <h5 class="text-green">Company</h5>
                    <ul class="list-unstyled">
